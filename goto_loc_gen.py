...
LOCS = {"dl":    {"destinations": [os.path.join(HOME, "downloads"),
        ...
        "work":  {"destinations": [os.path.join(HOME, "work")]},
        "svn":  {"destinations": [os.path.join(HOME, "cs", "svn")]},
        "sdk":  {"destinations": [os.path.join(HOME, "cs", "sdk")]},
        "cm":  {"destinations": [os.path.join(HOME, "cs", "chargemanager")]},
        "sm":  {"destinations": [os.path.join(HOME, "cs", "sysmgr")]},
        ...
        "ocu":  {"destinations": [os.path.join(HOME, "cs", "ocu")]},
        "ocub":  {"destinations": [os.path.join(HOME, "cs", "ocu-bootloader")]},
